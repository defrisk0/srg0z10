# HYPERSIGN
[RPC](http://hypersign.srgts.xyz:23457) | [API](http://hypersign.srgts.xyz:1347) | [gRPC](http://hypersign.srgts.xyz:9340)
...
````
Let's check sum genesis file (current as of August 2023 - 7de2e77cff6d601387a46a760e9c0d7a573b2cfdbdaebb0f04512878543fc0a1):
````
...
hid-noded tendermint unsafe-reset-all --home $HOME/.hid-node --keep-addr-book
SNAP_RPC="http://hypersign.srgts.xyz:23457"
