...
Install Besu:
````
wget https://hyperledger.jfrog.io/hyperledger/besu-binaries/besu/23.4.0/besu-23.4.0.tar.gz
tar -xvf besu-23.4.0.tar.gz
rm -rf besu-23.4.0.tar.gz
````
